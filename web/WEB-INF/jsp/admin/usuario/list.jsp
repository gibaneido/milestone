		...
		<div id="container">
			...
			<div id="content">
				...
				<ul class="menu-category clearfix">
					<li><a href="${pageContext.request.contextPath}/admin/usuario/novo.jhtml">Novo</a></li>
				</ul>
				<form name="filtro" action="${pageContext.request.contextPath}/admin/usuario/list.jhtml" method="GET">
					...
					<table class="grid">
						...
						<c:forEach var="usuario" items="${usuarioList}">
							<tr>
								<td><a href="${pageContext.request.contextPath}/admin/usuario/editar.jhtml?idUsuario=${usuario.id}"><c:out value="${usuario.nome}"/></a></td>
								<td><c:out value="${usuario.perfil.descricao}"/></td>
								<td><c:out value="${usuario.empreendimento.descricao}"/></td>
							</tr>
						</c:forEach>
						</tr>
					...
					<c:if test="${totalPages > 0}">
						<div class="pagination">
							<ul class="clearfix">
								<c:forEach begin="0" end="${(totalPages/150)-1}" var="i">
									<li>
										<c:choose>
